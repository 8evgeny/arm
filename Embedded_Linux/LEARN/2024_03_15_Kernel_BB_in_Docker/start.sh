#!/usr/bin/bash
# docker build --no-cache -t build_bb_kernel  /home/evg/SOFT/Github/Arm/Embedded_Linux/LEARN/2024_03_15_Kernel_BB_in_Docker
docker build -t build_bb_kernel  /home/evg/SOFT/Github/Arm/Embedded_Linux/LEARN/2024_03_15_Kernel_BB_in_Docker
docker run --name bb_uboot build_bb_kernel
mkdir -p to_SDCARD
docker cp bb_uboot:/home/evg/u-boot/u-boot.img to_SDCARD
docker cp bb_uboot:/home/evg/u-boot/MLO to_SDCARD
docker rm bb_uboot 
cd to_SDCARD
touch uEnv.txt
