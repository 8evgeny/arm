...
make ARCH=arm CROSS_COMPILE=$1 uImage dtbs LOADADDR=0x80008000 -j4 &>../log.txt 
make ARCH=arm CROSS_COMPILE=$1 -j4 modules &>>../log.txt 
make ARCH=arm CROSS_COMPILE=$1 INSTALL_MOD_PATH=../SDCARD/RFS/ modules_install &>>../log.txt 
pwd
