...
/*************************************************************************************
	 ...
	 используя аппаратные таймеры-счетчики и метод измерения по частоте. 
	 ...
	 На базе таймера TIMER3 организовано измерение количества поступающих импульсов 
	 за единицу времени. 
	 На базе таймера TIMER2 организован отсчет периода времени, в течение которого 
