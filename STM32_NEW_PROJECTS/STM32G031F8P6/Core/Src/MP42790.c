...
void get_full_soc_cells()
{
    ...
    CELL3_FULL_PERCENT = read_MP42790_8_CRC(FULL_SOC_CELL3) * 4 / 10 ;
    CELL4_FULL_PERCENT = read_MP42790_8_CRC(FULL_SOC_CELL4) * 4 / 10 ;
    CELL5_FULL_PERCENT = read_MP42790_8_CRC(FULL_SOC_CELL5) * 4 / 10 ;
    CELL6_FULL_PERCENT = read_MP42790_8_CRC(FULL_SOC_CELL6) * 4 / 10 ;
    CELLPACK_FULL_PERCENT = read_MP42790_16_CRC(FULL_SOC_PACK) * 2 / 1000 ;
